...
const steps = [
  {
    ...
    icon: "🎮",
    title: "Game Hacker",
    desc: "In sixth grade, started recording GTA gameplay for YouTube. When the screen recorder failed, he fixed it himself. Found Cheat Engine, modified game memory values, gave himself infinite cash. That one hack sparked everything.",
    accent: "#f59e0b",
    foldFrom: "#00d2a0",
    foldTo: "#00957a",
    num: "01",
  ...
  },
  {
    ...
    icon: "🛠",
    title: "Tool Builder",
    desc: "From game hacker → Kali explorer → web dev → tool builder. Curiosity has always been the engine. Now builds tools his friends and peers actively use every day.",
    accent: "#f59e0b",
    foldFrom: "#ff6b35",
    foldTo: "#c0392b",
    num: "04",
